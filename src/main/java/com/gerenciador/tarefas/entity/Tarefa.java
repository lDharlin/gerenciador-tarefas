...
public class Tarefa implements Serializable {
    ...
    public Tarefa(Long id, String titulo, String descricao, StatusTarefaEnum status, Usuario responsavel, Usuario criador, int quantidadeHorasEstimadas, Integer quantidadeHorasRealizada, LocalTime dataCadasto, LocalTime dataAtualizacao) {
        this.id = id;
        this.titulo = titulo;
